# Proyecto Final - Filtros para imagenes PGM con Apptainer y Docker (para usuarios en otro sistema operativo que no sea Linux o que tengan permisos de administrador)
